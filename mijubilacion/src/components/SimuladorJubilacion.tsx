                    ...
                    <form onSubmit={calcularIESS} className="space-y-8 relative z-10">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="number" step="0.01" min="1" required value={sueldoActual} onChange={e => setSueldoActual(e.target.value)} className="input-field pl-10 text-2xl py-4 bg-slate-800 text-white border-slate-500" placeholder="Ej: 1200.00" />
                            </div>
                        </div>
                        <div>
